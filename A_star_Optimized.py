...
class AStarPlanner:
    ...
    def calc_heuristic(n1, n2):  # n1传入ngoal，n2传入open表要计算的那个点
        """
        改进点1：启发函数距离公式 曼哈顿距离、对角线距离、欧式距离
        """
...
def main():
    ...
    plt.title("Visualization of the optimized A* algorithm")
